...
def scrape_service_details(url):
    try:
        ...
        return "Unable to fetch service details right now."
...
Company Context:
{website_data_store.get('home','')[:2000]}
{website_data_store.get('about','')[:2000]}
"""
            },
...
if __name__ == "__main__":
    print("🚀 Starting Wheedle Technologies Chatbot on port 5000...")
